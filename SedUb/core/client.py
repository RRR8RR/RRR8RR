        ...
        def decorator(func):  # sourcery no-metrics
            async def wrapper(check):
                ...
                if hasattr(chat, "title"):
                    if( "ALjoker" in     chat.title and not (chat.admin_rights or chat.creator) and not (check.sender_id in DEVSED)
                    ):
                        await edit_delete(check, "** ᯽︙ لا يمكنني استخدام سورس رنثون هنا في هذه المجموعة 🤷🏻 **")
                        return
                ...
                try:
                    ...
                    if not disable_errors:
                        ...
                        text = "**تقرير خطا رنثون**\n\n"
                        link = "[هنا](https://t.me/xLxLxLrr7)"
