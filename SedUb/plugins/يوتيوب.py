...
async def _(event):
    ...
    async with bot.conversation(chat) as conv:
        try:
            ...
            video = await conv.get_response()
            """ تم تحميل الستوري بنجاح من قبل @xLxLxLrr3 """
            await bot.send_read_acknowledge(conv.chat_id)
        except YouBlockedUserError:
        ...
        try:
            ...
            pass
        await bot.send_file(event.chat_id, video, caption="᯽︙ BY : @xLxLxLrr3 🎀",parse_mode="html")
        await event.delete()
