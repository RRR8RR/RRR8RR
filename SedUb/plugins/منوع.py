...
R = [
    ...
    "**-** مطور السورس **⪼ [Sin²ø :(: ](t.me/BxxBxxL)   \n"
    "**-** قناة السورس **⪼ [𐇮 رنثون ](t.me/xLxLxLrr3)   "
]
...
DevJoker = [6186856384]
#تضل تخمط من عمك رنثون ؟ الى اين يستمُر الفشل ياغُلام
...
async def Hussein(event):
    ...
    await event.edit(f'**ها هيَ الفيزات تم استخراجها من قبل سورس رنثون** \n@xLxLxLrr3:\n {response.text}')
...
async def Hussein(event):
    ...
    async for edited_response in event.client.iter_messages(bot_username, limit=1):
        if edited_response.id == response.id and edited_response.message != response.message:
            response = edited_response
    await event.edit(f'**ها هيَ المعلومات للفيزا تم استخراجها من قبل سورس رنثون** \n@xLxLxLrr3\n {response.text}')
...
async def Hussein(event):
    ...
    async for edited_response in event.client.iter_messages(bot_username, limit=1):
        if edited_response.id == response.id and edited_response.message != response.message:
            response = edited_response
    await event.edit(f'**ها هيَ البطاقة تم فحصها من قبل سورس رنثون** \n@xLxLxLrr3\n {response.text}')
